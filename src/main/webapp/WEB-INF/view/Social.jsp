...
<body>
	...
	<!-- Adding Social Service for Donors-->
	<form>
		<div class="Social Service" id="home-content4">
			...
			Address: <input type="text" name="Address"><br> Zipcode:<input
				type="integer" name="zipcode"><br> State: <select
				name="Choose State">
			...
			Service Type: <select name="Service type">
			...
			</select><br> Date:<input type="date" name="date"><br> Time:<input
				type="time"name"time"><br> Description:<input
