...
<body>
	...
	<div id="wrapper">
		...
		<div class="container">
			<h2>Need Help</h2>
			<p>If you feel ashamed about your need for love & support, it's
				because you were made to feel this way as a child. It's not a sign
				of weakness to want affirmation, reassurance or someone to count on;
				these are natural, appropriate needs. Just make sure to be there for
				yourself first</p>
		</div>
		...
		<div class="footer_container">
			...
			<div class="footerbottom">
				<div class="copyright">Copyright &copy; 2013 SymDonate. All
					rights reserved.</div>
			</div>
			<!--footerbottom-->
		</div>
